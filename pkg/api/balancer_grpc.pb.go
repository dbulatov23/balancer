...
func (c *userClient) CreateUser(ctx context.Context, in *UserInfo, opts ...grpc.CallOption) (*CreateUserResponse, error) {
...
func (UnimplementedUserServer) CreateUser(context.Context, *UserInfo) (*CreateUserResponse, error) {
